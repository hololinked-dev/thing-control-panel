...
export const TDDocViewer = ({ resource, type }: { resource: ResourceInformation; type: string }) => {
	const thing = useContext(ThingContext) as Thing;
	const tdFragment =
		thing.td[type === "action" ? "actions" : type === "event" ? "events" : "properties"][resource.name];
	return (
